...
const NMN23400 = () => {
  ...
  const textContainerYoko = (
    <>
      ...
      <p>NMNにはNAD量を増加させ、水素はNADを活性化させる効果があるとされております。そこで、日本国内では唯一無二の水素発生原料のマイクロクラスターHDを世界で初めて配合したことにより、NMNのもつ本来の力をより相乗させる効果に目し、設計された製品が「NMN23400MICROCLUSTERPREMIUM」なのです。</p>
